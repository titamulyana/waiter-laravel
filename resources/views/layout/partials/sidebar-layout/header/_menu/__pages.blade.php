...
<div class="menu-active-bg px-4 px-lg-0">
	...
	<div class="tab-content py-4 py-lg-8 px-lg-7">
		...
		<div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages">
			@include(config('settings.KT_THEME_LAYOUT_DIR').'/partials/sidebar-layout/header/_menu/__pages-general')
		</div>
		<!--end:Tab pane-->
		<!--begin:Tab pane-->
		...
		<div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_authentication">
			@include(config('settings.KT_THEME_LAYOUT_DIR').'/partials/sidebar-layout/header/_menu/__pages-authentication')
		</div>
		<!--end:Tab pane-->
		<!--begin:Tab pane-->
		<div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities">
			@include(config('settings.KT_THEME_LAYOUT_DIR').'/partials/sidebar-layout/header/_menu/__pages-utilities')
		</div>
		<!--end:Tab pane-->
		<!--begin:Tab pane-->
		<div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
			@include(config('settings.KT_THEME_LAYOUT_DIR').'/partials/sidebar-layout/header/_menu/__pages-widgets')
		</div>
		<!--end:Tab pane-->
	</div>
	<!--end:Tab content-->
